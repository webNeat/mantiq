...
import { call_prompt_fn, load_aliases } from '@src/lib'
...
call
  ...
  .action(async (prompt_path, fn_name, parameter) => {
    ...
    console.log(JSON.stringify(await call_prompt_fn(aliases[prompt_path] || prompt_path, fn_name, parameter), null, 2))
  })
